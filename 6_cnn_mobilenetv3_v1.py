####################################################################
"""MOBILENETV3 REMOVING THE LAST 2 LAYERS: Pooling and Classifier"""
####################################################################
...
mobilenet_v3 = nn.Sequential(*list(mobilenet_v3.children())[:-2])
...
class CombinedModel(nn.Module):
    def __init__(self, num_classes=100):
        ...
        self.custom_cnn = CustomCNN(in_channels=960, num_classes=num_classes)
