####################################################################
"""MOBILENETV3 ACCESSING THE 15TH LAYER"""
####################################################################
...
# print(mobilenet_v3)
mobilenet_v3 = nn.Sequential(*list(mobilenet_v3.features.children())[:15])
# print(mobilenet_v3)
...
class CombinedModel(nn.Module):
    def __init__(self, num_classes=100):
        ...
        self.custom_cnn = CustomCNN(in_channels=160, num_classes=num_classes)
...
for epoch in range(num_epochs):
    ...
    if test_accuracy > best_accuracy:
        torch.save(model.state_dict(), 'best_checkpoint_mobilenetv3_large.model')
